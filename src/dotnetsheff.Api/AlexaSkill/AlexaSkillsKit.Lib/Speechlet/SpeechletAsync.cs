...
namespace AlexaSkillsKit.Speechlet
{
    public abstract class SpeechletAsync : ISpeechletAsync
    {
        ...
        public abstract Task<SpeechletResponse> OnIntentAsync(IntentRequest request, Session session);
        public abstract Task<SpeechletResponse> OnLaunchAsync(LaunchRequest request, Session session);
